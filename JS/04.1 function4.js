...
console.log("--------- *** Bài 33: Block scope và từ khoá var *** ---------");
//
...
console.log("--------- *** Bài 34: Closure cơ bản *** ---------");
// Lexical scope
...
console.log("--------- *** Trường hợp 1 Closure *** ---------");
...
console.log("--------- *** Trường hợp 2 Closure *** ---------");
...
console.log("--------- *** Bài 35: Closure cơ bản *** ---------");
// *** Trường hợp 3 Closure
console.log("--------- *** Trường hợp 3 Closure *** ---------");
...
console.log("--------- *** Bài 39: Arrow function cơ bản*** ---------");
// Arrow function: anoymous function
console.log("--------- *** Arrow function: anoymous function *** ---------");
//Nornal function : anoymous function
console.log("--------- *** Nornal function : anoymous function *** ---------");
...
//
// rut gọn khi return
console.log("--------- *** rut gọn khi return *** ---------");
const square2 = () => x * x;
//
