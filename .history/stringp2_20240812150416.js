...
// -- startsWith: bắt đầu từ xxhuwx kết quả trả ra true hoặc false
console.log(myStr.startsWith("Frontend")); //kết quả true
console.log(myStr.startsWith("frontend")); //kết quả false
// -- endsWith
console.log(myStr.endsWith("frontend")); //kết quả false
