...
// slice(start, end): start vị trí ban đầu và end là vị trí kết thúc,  nó sẽ lsao chép từ phần tử start đến phần tử end - 1
console.log(
    "--------- *** slice(start, end): start vị trí ban đầu và end là vị trí kết thúc,  nó sẽ lsao chép từ vị trí start đến phần tử end - 1 *** ---------"
);
