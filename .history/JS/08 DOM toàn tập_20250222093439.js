...
console.log("--------- 21. elementinsertAdjacentText() ---------");
...
console.log("--------- *** Bài 131: insertAdjacentElement  *** ---------");
// 22. insertAdjacentElement("position", "text: là chuỗi")
console.log("--------- 22. element.insertAdjacentElement() ---------");
