...
// mình phải làm theo trình tự khai báo trước rồi mình mới gọi sẽ ko bị lỗi(error)
// còn function functionName(parameters, parameters), Function declarationc thì tự  động chuyển đổi

// *** *** IIFE ==> Immemdiately Invoked Function Execution
// Immemdiately(Ngay lập tức) 
// Invoked(Được gọi)
// Function(Chức năng) 
// Execution(Thực hiện) :Thực thi hàm được gọi ngay lập tức
