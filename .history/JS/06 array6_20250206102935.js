...
// concat: gọp lại các mảng vào nhau
console.log("--------- concat: gọp lại các mảng vào nhau  ---------");
// Cách 1: array1.concat(array1, array2, array3, arrayN)
const array1 = [1, 2];
const array2 = [3, 4];
const array3 = [5, 6];
...
console.log("--------- Cách 2: spread operator  ---------");
// [... array]
...
console.log("--------- *** Bài 76: Destructuring là gì ? *** ---------");
// Destructuring array
...
console.log(a1, b1, c1); // -> ball sword arrow
// const [indexName, indexName, indexName] = toys;
const [x, y, z] = toys;
console.log(x, y, z);
const [magic, water, fire] = toys;
console.log(magic, water, fire);

//
// *** *** *** *** ***
//Bài 77: Tìm hiểu rest parameter
console.log("--------- *** Bài 77: Tìm hiểu rest parameter *** ---------");
// rest parameter ...
console.log("--------- rest parameter  ---------");
const [ball, sword, arrow, ...resr] = toys;
