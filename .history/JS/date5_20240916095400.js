...
function timeSince(date) {
    // conunter Time - date
    const now4 = new Date();
    const youDate1 = new Date(date);
    const seconds1 = Math.floor((now4.getMonth.Time() - youDate1()) / 1000); // in ra giây dùng now.getMonth.Time() trừ (-)  youDate() và chia cho (/) 1000, làm tròn số giây dùng Math.floor
