...
// for of
// for (value of array){
console.log("--------- *** VD 1 Vòng lặp for of   *** ---------");
//}
...
console.log("--------- *** VD 2 Vòng lặp for of   *** ---------");
...
console.log("--------- *** VD 3 Vòng lặp for of   *** ---------");
...
console.log("--------- *** VD 4 Vòng lặp for of   *** ---------");
...
console.log("--------- *** VD 5 Vòng lặp for of về str  *** ---------");
