...
const li1 = document.getElementsByTagName("li"); // -> NodeList(5) [li.item, li.item, li.item, li.item, li.item]
console.log(li1); // -> NodeList(5) [li.item, li.item, li.item, li.item, li.item]
console.log("--------- HTMLCollection ---------");
const li2 = document.querySelectorAll("li"); // -> HTMLCollection(5) [li.item, li.item, li.item, li.item, li.item]
console.log(li2); // -> HTMLCollection(5) [li.item, li.item, li.item, li.item, li.item]
