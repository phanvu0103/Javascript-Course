...
// object.keys() -> trả về 1 mảng chứa tất cả các key của object
console.log(
    "--------- object.keys() -> trả về 1 mảng chứa tất cả các key của object ---------"
);
...
// object.values() -> trả về 1 mảng chứa tất cả các value (giá trị) của object
console.log(
    "--------- object.values() -> trả về 1 mảng chứa tất cả các value (giá trị) của object ---------"
);
...
// object.entries(obj) -> trả về 1 mảng chứa tất cả các key và value của object
console.log(
    "--------- object.entries() -> trả về 1 mảng chứa tất cả các key và value của object ---------"
);
