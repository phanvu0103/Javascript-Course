...
// 15 hàm JavaScript bắt buộc phải thành thạo nếu muốn trở thành lập trình viên Super Vip Pro
console.log("--------- *** Các hàm trong JavaScript là một phần bắt buộc và không thể thiếu để cho các lập trình viên có thể thỏa sức sáng tạo và thiết kế. Các hàm này nếu biết cách sử dụng còn có thể giúp các đoạn code của bạn trở nên gọn và dễ đọc hơn. Trong bài viết này tôi sẽ cùng với các bạn tìm hiểu kỹ hơn về 15 hàm JavaScript thường dùng nhất nhé.
 *** ---------");
