...
const birthday = new Date(1985, 3, 3);
//
console.log(birthday.getFullYear()); // print year 1985
//
console.log(birthday.getMonth()); // print month 1 ==> getMonth() 0 --> 11, 0 tháng 1(jan) -> 11 tháng 12(dec)
//
console.log(birthday.getDay()); // print day 3
