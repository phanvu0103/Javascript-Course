...
console.log("--------- *** Null --> nothing : là trống không *** ---------");
console.log(d);

// *** Boolean --> true or flase ***
console.log("--------- *** Boolean --> true or flase  *** ---------");
// falsy values vs truthy values
console.log("--------- *** falsy values vs truthy values *** ---------");
// falsy values: "", 0, false, underfined, null
console.log("--------- *** falsy values: "",( 0, false, underfined, null) *** ---------");
// truthy values: "abc", 1, true, 100, 1000
console.log("--------- *** truthy values: "abc", 1, true, 100, 1000 *** ---------");
