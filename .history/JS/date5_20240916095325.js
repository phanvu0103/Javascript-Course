...
function timeSince(date) {
    ...
    const seconds = Math.floor((now.getMonth.Time() - youDate1()) / 1000); // in ra giây dùng now.getMonth.Time() trừ (-)  youDate() và chia cho (/) 1000, làm tròn số giây dùng Math.floor
    console.log(seconds);
}
