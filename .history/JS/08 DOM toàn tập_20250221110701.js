...
console.log("--------- thêm  <div class = containers ></div> ---------");
div.classList.add("containers");
console.log(div); // -> <div class="containers"></div>
// thêm đoạn văn vào elemmet div có class containers
console.log("--------- <div class = containers>Loading...126: document.appendChild</div> ---------");
div.textContent = "Loading...126: document.appendChild";
console.log(div); // <div class="containers">Loading...126: document.appendChild</div>
console.log("--------- <div class = containers1 wrapper>Loading...126: document.appendChild</div> ---------");
div.className = "containers1 wrapper";
console.log(div); // <div class="containers1 wrapper">Loading...126: document.appendChild</div>
