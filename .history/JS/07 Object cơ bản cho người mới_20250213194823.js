...
for (let key in student) {
    ...
    console.log(student[key]); // -> kết quả tương ứng với key là biến, còn "" không phải string
    // nhập vậy hơi rối nên mình gọp làm 2 dòng thành 1
