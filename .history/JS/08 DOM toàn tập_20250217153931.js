...
console.log("--------- document.getElementsByClassName("") -> trả về 1 mảng các node nếu tồn tại class, ngược lại trả về mảng rỗng. ---------");
...
console.log("--------- document.getElementsByClassName() -> trả về một HTMLCollection chứa danh sách các node, nếu không có thì trả về empty HTMLCollection. ---------");
