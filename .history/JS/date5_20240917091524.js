...
console.log("--------- ** Bài 43: Các hàm get trong Date *** ---------");
...
console.log("--------- *** Bài 44: Các hàm set trong Date *** ---------");
...
console.log("--------- *** Bài 45: Tìm hiểu utc trong Date *** ---------");
...
console.log("--------- *** Bài 50: Giải bài tập chương 5 bài 1 *** ---------");
...
console.log("--------- *** Bài 51: Giải bài tập chương 5 bài 2 *** ---------");
