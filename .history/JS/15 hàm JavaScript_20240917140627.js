...
numbers4.forEach((num) => console.log(num * 2)); // 2, 4, 6, 8
...
// Giải thích: Trong ví dụ này, slice() trích xuất các phần tử từ chỉ mục 2 đến 4 (loại trừ  1 ) khỏi fruits.
...
numbers5.splice(2, 1, 99);
console.log(numbers5); // [1, 2, 99, 4, 5]
...
const numbers7 = [1, 2, 3, 4, 3];
const index1 = numbers7.lastIndexOf(3);
console.log(index); // 4
