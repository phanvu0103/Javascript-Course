...
console.log(div.setAttribute("data-name", "evondev")); // -> <div class="containers1 wrapper"  data-name="evondev"> trong html
...
body.appendChild(h2);
h2.appendChild(text);
console.log(h2.appendChild(text));
//
//
// *** *** *** *** ***
// Bài 128: cloneNode
