...
console.log(
    "--------- 24.  Traversing DOM phần 2: nextElementSibling, previousElementSibling, childNode vs children, firstChild vs firstElementChild ---------"
);
//
...
console.log(
    "--------- 27. childNode: trả về hết các node bên trong bao gồm textNodes ---------"
);
...
console.log("--------- lastChild vs firstElementChild---------");
