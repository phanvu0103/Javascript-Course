...
console.log("--------- 2. document.querySelectorAll() -> trả về 1 mảng các node nếu tồn tại selector, ngược lại trả về mảng rỗng, trả về NodeList chứa danh sách các node, nếu không có thì trả về empty NodeList. ---------");
...
console.log(
    "--------- 04. Selector getAttribute() -> lấy ra giá trị của attriute seletor trả về giá trị của thuộc tính của phần tử. Attribute: là các thuộc tính của phần tử như: id, class, src, href, alt, title, style, data-*,..., ---------"
);
