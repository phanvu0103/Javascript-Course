...
// nó giống Array nhưng không phải Array, nên không thể sử dụng các phương thức của Array như: push, pop, shift, map, filter, reduce, forEach...
console.log("--------- lấy được nhiều select---------");
const multiNode2 = document.querySelectorAll(".item");
