...
console.log("--------- *** 143: getBoundingClientRect  *** ---------");
console.log(
    "--------- 34. selectors.getBoundingClientRect(): lấy ra vị trí (tọa độ kích thước) của phần tử ---------"
);
log(boxed.getBoundingClientRect()); //DOMRect {x: 0, y: 208, width: 200, height: 200, top: 208, …} bottom: 408, height: 200, left: 0, right:200, top: 208, width: 200, x: 0y: 208
