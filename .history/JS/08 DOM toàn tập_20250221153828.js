...
console.log(
    "--------- 04. cloneNode: là bản sao trước đó để làm nhiệm vụ khác ---------"
);
// 04. cloneNode là bản sao trước đó để làm nhiệm vụ khác
...
("--------- 05. hasChildNodes: kiểm tra elemmet của chúng ta có phần tử con hay ko (child) có trả về => true, ko thì trả về => false ---------");
// 05. hasChildNodes: kiểm tra element của chúng ta có phần tử con hay ko (child) có trả về => true, ko thì trả về => false
// console.log(h2.hasChildNodes()); // -> true
console.log(document.querySelector("h2").hasChildNodes());
