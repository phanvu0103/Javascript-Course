...
const div = document.createElement("div"); // -> chưa hiện ra ngoài html mình phải qua bước thứ 2
// 02. selector.appendChild
// selector.appendChild
// document.body -> thẻ body => trường hơpk này đặc biệt
// document.querySelector("body"); -> trường hợp này hay dùng còn ở trên là d
