...
//  map thì trả lại mảng mới dựa vào mảng ban đầu còn forEach thì không
console.log("--------- *** forEach chạy không dừng ko có return nên chạy mãi thường dùng trong dom *** ---------");
//forEach chạy không dừng ko có return nên chạy mãi thường dùng trong domconsole.log("--------- *** forEach chạy không dừng ko có return nên chạy mãi thường dùng trong dom *** ---------");