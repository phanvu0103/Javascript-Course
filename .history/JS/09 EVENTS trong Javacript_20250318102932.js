...
link.addEventListener("click", function (event) {
    ...
    //Lấy custom attribute data-abc -> Bài 157: Tìm hiểu object style
    // .dataset.name -> Bài 157: Tìm hiểu object style
    // event.target.dataset.name -> Bài 157: Tìm hiểu object style;
    const name = event.target.dataset.name; // nếu name-abc dài thì mình  const name = event.target.dataset.name
    console.log(name);
});
//
//
