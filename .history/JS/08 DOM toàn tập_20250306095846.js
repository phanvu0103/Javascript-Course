...
// Điểm giống: có thể tru cập bằng index,có độ(length) cơ bản, giống mảng nhưng ko hẳn làm mảng, tức là ko sử dụng được những phương thức đã học như: pop 
// HTML Collection: ko sử dụng được forEach, map, filter, reduce, find, findIndex
// NodeList: sử dụng được forEach, map, filter, reduce, find, findIndex
