...
function handleTabClick(event) {
    ...
    // [...tabContent].forEach((item) => item.classList.remove("active")); // -1 de lay index cua tab content tuong ung nhưng thay đổi thứ tự thì ko đúng như mình html đặt ra nên mình thê dấu {} sau
