...
function logYourName() {
    let myName2 = evondev; // function scope: là nằm trong function
    console.log(myName2);
}
// console.log(myName); // Global scope ko nằm trong function thì ở đâu cũng gọi đc, còn function scope thì mình chỉ gọi trong function ko thì console.log(myName2);: báo lỗi function4.js:109 Uncaught ReferenceError: myName2 is not defined
logMyName();
