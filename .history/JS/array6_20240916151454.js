...
// Đoạn bị ẩn khúc cuối khi mình nói là "Khi mình viết join như thế này ("")" thì nó sẽ dính nhau ví dụ mình có arr = ["b","nam"] khi dùng arr.join("") thì sẽ có kết quả là "tuannam", còn nếu chúng ta điền từ vào trong join ví dụ arr.join("-") thì sẽ có kết quả là "tuan-nam" nhé. Xin lỗi các bạn vì sự thiếu sót này