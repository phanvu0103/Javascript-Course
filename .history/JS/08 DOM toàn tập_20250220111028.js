...
console.log("--------- 6. Selector removeAttribute() -> xóa thuộc tính của phần tử. ---------");
...
console.log("--------- Selector.hasAttribute("attribute") -> kiểm tra xem (selector) phần tử có thuộc tính đó không, nếu có trả về true, ngược lại trả về false. ---------");
