...
function handleTabClick(event) {
    ...
    // [...tabContent][tabNumber - 1].classList.add("active"); // -1 de lay index cua tab content tuong ung nhưng thay đổi thứ tự thì ko đúng như mình html đặt ra nên mình thê 
