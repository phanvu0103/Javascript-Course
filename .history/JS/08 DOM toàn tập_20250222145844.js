...
console.log(
    "--------- 24.  Traversing DOM phần 2: nextElementSibling, previousElementSibling, childNode vs children ---------"
);
//
console.log("--------- nextElementSibling: tìm phần tử kế tiếp ---------");
const nextSpan = span.nextElementSibling;
console.log(nextSpan); // ->  <span class="span">abc</span> tìm ko thấy trả về null
console.log(
    "--------- previousElementSibling: tìm phần tử đứng sau nó ---------"
);
...
console.log("--------- childNode: trả về hết các node bên trong bao gồm textNodes ---------");
console.log(span.childNodes)
console.log("--------- children: trả về các Node ko bao gồm textNodes ---------");
console.log(span.chi);
