...
// *** *** *** *** ***
//  142: Window
console.log("--------- *** 142: Window  *** ---------");
console.log(
    "--------- 33. Window.innerWidth, Window.innerHeight , Window.outerWidth, Window.outerHeight  ---------"
);
log(window.innerWidth); // -> 1280 lấy chieur rong cua man hinh
log(window.outerWidth); // -> 1280 lý chieur rong cua man <hinh></hinh>
log(window.innerHeight); // -> 800 lý chiều cao cua man hinh
log(window.outerHeight); // -> 800 lý chiều cao cua man <hinh></hinh>