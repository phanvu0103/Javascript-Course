...
function timeSince(date) {
    ...
    const seconds9 = Math.floor((now4.getTime() - youDate7.getTime()) / 1000); // in ra giây dùng now.getMonth.Time() trừ (-)  youDate() và chia cho (/) 1000, làm tròn số giây xuống dùng Math.floor
