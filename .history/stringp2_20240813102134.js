...
// -- trimEnd -- 
console.log(myStr.trimEnd()); //remove space lest and right (xóa khoảng trống bên trái và bên phải)
// -- trimStart --
console.log(myStr.trimStart()); // remove space lest and right (xóa khoảng trống bên trái và bên phải)
// -- charAt --
