...
// -- includes
console.log(myStr.includes("end")); //kết quả kiểm tra có chữ "end" trong Frontend thì hiện t
console.log(myStr.includes("abc")); //kết quả kiểm tra có chữ "end" trong Frontend